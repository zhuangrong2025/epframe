    ...
    UserRoleAdd.prototype._renderStep = function() {
        this.step = new ESYS.step({
            ...
            items: [{
                name : 'role',
                title: '角色信息',
                url: ESYS.formaturl('/EPWEBRUN/epframe/release/esystem/userrole/userrolemanage/custom/child/RoleInfoStep'), 
                options: { 
                    dep_id: this.dep_id
                }
            }, {
                ...
                name:'rights',
                title: '开启权限',
                url: ESYS.formaturl('/EPWEBRUN/epframe/release/esystem/userrole/userrolemanage/custom/child/RoleRightStep'), 
                options: { 
                    dep_id: this.dep_id
                }
            }, {
                ...
                name : 'users',
                title: '关联用户',
                url: ESYS.formaturl('/EPWEBRUN/epframe/release/esystem/userrole/userrolemanage/custom/child/UserBindStep'), 
                options: {
                    dep_id: this.dep_id
                }
            }],
